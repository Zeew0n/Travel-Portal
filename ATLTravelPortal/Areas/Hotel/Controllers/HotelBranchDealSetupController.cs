...
namespace ATLTravelPortal.Areas.Hotel.Controllers
{
    ...
    public class HotelBranchDealSetupController : Controller
    {
        ...
        public ActionResult Index(int? id, string FilterDealIdentifierId, int? FilterHotelId, int? FilterCurrencyId)
        {
            ...
            viewmodel.DealList = mDealProvider.GetAllDeals(id, FilterDealIdentifierId, FilterHotelId, FilterCurrencyId);
        ...
        public ActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                bool result = false;
                TravelSession obj = (TravelSession)Session["TravelPortalSessionInfo"];
                result = mDealProvider.Delete_Htl_BranchDeals(id, obj.AppUserId);
