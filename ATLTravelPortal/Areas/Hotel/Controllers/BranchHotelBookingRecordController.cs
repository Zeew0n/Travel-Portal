...
{
    public class BranchHotelBookingRecordController : Controller
    {
        //
        // GET: /Hotel/BranchHotelBookingRecord/
        ...
        public ActionResult Index(int? page)
        {
            ...
            _model.Message = msg;
            _model.TabularList = _rep.GetBranchOfficePagedList(page);
        ...
        public ActionResult Index(ExportModel Expmodel, HotelBookingRecordModel model, FormCollection frm, int? page)
        {
            ...
            model.TabularList = _rep.GetBranchOfficePagedList(page);
                ...
                Expmodel.ExportTypePdf != null))
            {
                try
                {
                    ...
                    var exportData = _rep.BranchOfficeList().Select(m => new
                    {
                        SNo = m.SNo,
