               ...
               <%foreach (var item in Model.TabularList)
                {
                    ...
                    <tr id="tr_<%=sno %>" class="<%:classTblRow %>" onmouseover="this.className='GridRowOver'"
                        ...
                        <td>
                         <%:item.BookingDetail.Guests[0].GuestState%> <%:item.BookingDetail.Guests[0].FirstName%> <%:item.BookingDetail.Guests[0].FirstName%> <%:item.BookingDetail.Guests[0].LastName %>
                        </td>
                        <td>
                        ...
                        <%--<td>
                            <p>
                               <%:Html.ActionLink("Detail", "CancelDetail", new { id = item.BookingCancelId, controller = "HotelBookingRecord", area = "Hotel" }, new { @class = "", @title = "Details" })%>
                            </p>
                        </td>--%>
                    </tr>
