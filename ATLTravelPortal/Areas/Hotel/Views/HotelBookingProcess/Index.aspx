        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <tbody>
               <%foreach (var item in Model.TabularList)
                {
                    ...
                    <tr id="tr_<%=sno %>" class="<%:classTblRow %>" onmouseover="this.className='GridRowOver'"
                        ...
                        <td>
                            <p>
                               <%:Html.ActionLink("Detail", "Process", new { id = item.BookingRecordId, controller = "HotelBookingProcess", area = "Hotel" }, new { @class = "", @title = "Details" })%>
                            </p>
                        </td>
                    </tr>
               <%  }%>
             ...
             <%--  <%  if (Model.TabularList.TotalItemCount > ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize)
                {%>--%>
        <div class="pager">
            <%:MvcHtmlString.Create(ATLTravelPortal.Areas.Hotel.Pagination.PagingExtensions.Pager(Html, ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize, Model.TabularList.PageNumber, Model.TabularList.TotalItemCount,true,true,"", Url.Content("~/Hotel/HotelBookingProcess")))%>
        </div>
               <%  }
