        ...
        public string RenderHtml(bool IsDdl, bool IsTotal, string action,string virtualPath)
        {
            ...
            if (IsDdl == true)
            {
                sb.AppendFormat("<select id=\"recordDisplayCount\" style=\"width:50px\" onchange=\"RedirectPath('" + GeneratePageCountDdlLink(this.currentPage, virtualPath) + "')\" >" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 5) ? "selected" : "") + ">5</option>" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 10) ? "selected" : "") + ">10</option>" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 20) ? "selected" : "") + ">20</option>" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 30) ? "selected" : "") + ">30</option>" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 50) ? "selected" : "") + ">50</option>" +
                                       "<option " + ((ATLTravelPortal.Areas.Hotel.Repository.HotelGeneralRepository.DefaultPageSize == 100) ? "selected" : "") + ">100</option>" +
                                       "</select>");
            }
            if (IsTotal == true)
            {
