...
{
    public class HotelPendingBookingRepository
    {
        private DateTime CurrentDateTime = ATLTravelPortal.Repository.GeneralRepository.CurrentDateTime();
        public IEnumerable<ATLTravelPortal.Areas.Hotel.Models.HotelBookingRecordModel> List()
        {
        ...
        public IPagedList<ATLTravelPortal.Areas.Hotel.Models.HotelBookingRecordModel> GetPagedList(int? page)
        {
