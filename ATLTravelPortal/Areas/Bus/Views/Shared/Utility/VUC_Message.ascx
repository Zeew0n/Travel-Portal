<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ATLTravelPortal.Areas.Bus.Models.BusMessageModel>" %>
...
<% ATLTravelPortal.Areas.Bus.Repository.BusGeneralRepository.ActionMessage = null; %>
