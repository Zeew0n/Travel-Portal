    ...
    <div class="contentGrid">
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <tr>
                ...
                <td>
                    <p>
                        <%:Html.ActionLink("Itinerary", "Detail", new { id = item.BusPNRId, controller = "BranchItinerary", area = "Bus" }, new { title = "Edit"})%>
        ...
        <div class="pager">
            <%:MvcHtmlString.Create(ATLTravelPortal.Areas.Bus.Pagination.PagingExtensions.Pager(Html, ATLTravelPortal.Areas.Bus.Repository.BusGeneralRepository.DefaultPageSize, Model.TabularList.PageNumber, Model.TabularList.TotalItemCount, true, true, "", Url.Content("~/Bus/BranchIssuedTicket/Index")))%>
        </div>
        <%}
