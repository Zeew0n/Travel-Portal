    ...
    <tbody>
        <tr class="optional">
            <td>
              ...
              <td>
                <%:Html.DropDownListFor(model => Model.BusOperatorId, Model.BusOperatorList, "--Select--", new {@style="width:60px;"})%>
            </td>
            <td>
                <%:Html.DropDownListFor(model => Model.BusCategoryId, Model.BusCategoryList, "--Select--", new { @style = "width:60px;" })%>
            </td>
            <td>
