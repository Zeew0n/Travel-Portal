...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="pageTitle">
            <h3>
                <a href="#" class="icon_plane">Ticket Management</a> <span>&nbsp;</span><strong>Issued
                    Ticket</strong>
            </h3>
        </div>
    </div>
    ...
    <div class="contentGrid">
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <tr>
                ...
                <td>
                    <p>
                        <%:Html.ActionLink("Itinerary", "Detail", new { id = item.BusPNRId, controller = "DistributorItinerary", area = "Bus" }, new { title = "Edit"})%>
        ...
        <div class="pager">
            <%:MvcHtmlString.Create(ATLTravelPortal.Areas.Bus.Pagination.PagingExtensions.Pager(Html, ATLTravelPortal.Areas.Bus.Repository.BusGeneralRepository.DefaultPageSize, Model.TabularList.PageNumber, Model.TabularList.TotalItemCount, true, true, "", Url.Content("~/Bus/DistributorIssuedTicket/Index")))%>
        </div>
        <%}
