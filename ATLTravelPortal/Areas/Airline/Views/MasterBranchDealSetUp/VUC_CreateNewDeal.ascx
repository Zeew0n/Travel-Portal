...
<% using (Html.BeginForm("Create", "MasterBranchDealSetUp", FormMethod.Post, new { @class = "validate" }))
   {%>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                  ...
                  <%: Model.BranchOfficeCode + "-"%>  <%: Html.TextBoxFor(model => model.DealName, new { @class = "required", @onkeypress = "return CheckDealName(event)" })%>
