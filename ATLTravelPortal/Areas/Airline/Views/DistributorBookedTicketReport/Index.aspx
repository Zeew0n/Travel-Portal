        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <tr>
               ...
               <%-- <td>
                 ...
                 <%: Html.ActionLink("Issue", "Issue", new { Id = item.PNRId, AgentId = Model.AgentId, FromDate = Model.FromDate, Todate = Model.ToDate, AType= Model.AirlineTypesId }, new { @onclick = "return confirm('Are you sure you want to Issue?')" })%> 
                </td>
                <td>
                   
                         <%: Html.ActionLink("Cancel", "Cancel", new { Id = item.PNRId, AgentId = Model.AgentId, FromDate = Model.FromDate, Todate = Model.ToDate, AType = Model.AirlineTypesId }, new { @onclick = "return confirm('Are you sure you want to Cancel?')" })%> 
                </td>--%>
                 <td>
                        <%--<a href="/Airline/BookedTicketReport/Cancel/<%: item.PNRId %>" class="Details" target="_blank">
                            Cancel </a>--%>
