...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% }%>
        ...
        <div class="pageTitle">
            ...
            <h3>
                <a href="#" class="icon_plane">Package Management</a> <span>&nbsp;</span><strong>Custom Package Inquiry</strong>
            </h3>
        </div>
    </div>
           ...
           { %>
            ...
            <td>
                <p>
                    ...
                    <a href="/Airline/AirPackageCustomizeInquiry/Detail/<%: item.PId %>" class="details" title="Detail"></a>
                    <a href="/Airline/AirPackageCustomizeInquiry/Delete/<%: item.PId %>" class="delete" title="Delete"
