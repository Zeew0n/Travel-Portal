    ...
    <%: Html.ValidationSummary(true) %>
     ...
     <div class="pageTitle">
        <ul class="buttons-panel">
            ...
            <li>
               <input type="button" value="Cancel" class="cancel" onclick="document.location.href='/Airline/TravelFare/'" />
      ...
      <legend> Round Trip Fare</legend>
        ...
        <div class="form-box1-row">
            ...
            <div class="form-box1-row-content float-right">
                <div>
                <label>
                        <%: Html.Label("Going Fare in $ ")%>
                    </label>
                    <%: Html.TextBoxFor(model => model.RoundWayGoingUSD, new { @class = "txt1" })%>
        ...
        <div class="form-box1-row">
            ...
            <div class="form-box1-row-content float-right">
                <div>
                    ...
                    <%: Html.TextBoxFor(model => model.RoundWayReturnUSD, new { @class = "txt1" })%>
                </div>
            </div>
        </div>
        <div class="form-box1-row">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div> <label> <%:Html.Label("Child Fare On") %></label>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                   <label><%: Html.Encode("Infant Fare")%></label>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    <label> <%: Html.Label("Infant Fare On") %></label>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    <label>
                        <%: Html.Label("Effective From")%>
                    </label>
                    <%--<%: Html.TextBoxFor(model => model.EffectiveFrom, new {@readonly = true })%>--%>
            ...
            <div class="form-box1-row-content float-right">
                <div>
                    ...
                    <%-- <%: Html.TextBoxFor(model => model.ExpireOn, new {@readonly = true })%>--%>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div id="Error">
                     <label><%: Html.Label("Currencies")%></label>
            ...
            <div class="form-box1-row-content float-right">
                <div>
                     <label>
                    <%:Html.Label("Valid till further notice") %></label>
        ...
        <div class="row1 mrg-top-20">
         ...
         <div class="buttonBar">
<input type="submit" value="Save"  />     <input type="button" onclick="document.location.href='/TravelFare/'" value="Cancel"  />  
                </div>
    </div>
    <% } %>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#EffectiveFrom").datepicker({ minDate: new Date() });
            var min = $("#EffectiveFrom").val();
            $("#ExpireOn").datepicker({ minDate: min });
            $('#EffectiveFrom').val('');
            $('#ExpireOn').val('');
            $(".txt1").each(function () {
