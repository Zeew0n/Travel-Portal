...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="pageTitle">
        <ul class="buttons-panel">
            ...
            <li>
                <input type="button" value="Cancel" class="cancel" onclick="document.location.href='/Airline/OfflineIssueSource/Index'" />
            </li>
        </ul>
        <h3>
            <a href="#" class="icon_plane">Manage Offline Issue Source</a> <span>&nbsp;</span><strong>Create Offline Issue Source</strong>
        </h3>
    </div>
    <div class="row-1">
