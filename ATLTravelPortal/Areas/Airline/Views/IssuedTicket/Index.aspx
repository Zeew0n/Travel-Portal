...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentGrid">
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <%-- <%if (Model.IssuedTicketList != null)
              { %>--%>
            <%var sno = 0;
            ...
            <tr>
                ...
                <td>
                    <% if (item.TicketStatusName == "B2C-Offline-Issue-Confirm")
                       {%>
                ...
                <td>
                    <a href="/Airline/Invoice/Index/<%:item.PNRId %>" class="Details" target="_blank">Branch
                        Invoice</a> || <a href="/Airline/AgentInvoice/Index/<%:item.PNRId %>" class="Details"
                            target="_blank">Agent Invoice</a>
                </td>
                <td>
                    <%: Html.ActionLink("Edit", "Details", "AirOfflineBook", new { Id = item.PNRId }, null)%>
                </td>
            </tr>
            <% } %>
            <%}
