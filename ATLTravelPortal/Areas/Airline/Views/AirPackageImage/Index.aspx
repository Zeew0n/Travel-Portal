<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AirlineMain.Master"
 Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Airline.Models.AirPackageImageModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Package Image List</asp:Content>
...
<% Html.RenderPartial("~/Views/Shared/Utility/VUC_ActionResponse.ascx"); %>
    ...
    <div class="ledger_subtable create_tbl" style="margin: 1px 0">
        <div class="pageTitle">
            <h3>
                <a href="#" class="icon_plane">Package Management</a> <span>&nbsp;</span><strong>Package Image List</strong>
            </h3>
        </div>
    </div>
    <div class="contentGrid">
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <td><input type="radio" id="PackageDefaultImageId<%:item.PackageImageId %>" 
            name="PackageDefaultImageId" value="<%: item.PackageImageId %>" title="click to set the default image" /></td>            
            <td>
                <p>                    
                    <a href="/Airline/AirPackageImage/Delete/<%: item.PackageImageId %>?PID=<%: item.PackageId %>" 
    ...
    <div style="clear:both;"></div>
     ...
     <%using (Html.BeginForm("", "", FormMethod.Post, new { @enctype = "multipart/form-data", @id = "ATForm", @name = "ATForm" }))
      ...
      <input type="button" name="Cancel" value="Cancel" onclick="document.location.href='/Airline/AirPackage/'" />      
      <%} %>
    </div>
</asp:Content>
...
<script src="/Scripts/ATL.function.js" type="text/javascript"></script>
    ...
    $(document).ready(function () {
        $("#ATForm").validate();
        $("input[type='radio'][name='PackageDefaultImageId']").live("click", function () {
            var data = $(this).val();
            $.ajax({
                async: false,
                type: "POST",
                url: "/Airline/AirPackageImage/SetDefaultImage/" + data,
                data: data,
