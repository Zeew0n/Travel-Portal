 ...
 <div class="pageTitle">
    <ul class="buttons-panel">
      ...
      <div class="float-right">
        <input type="button" onclick="document.location.href='/Airline/AirPackageInquiry/Index'" value="Cancel" />
    </div>
    <h3><a href="#" class="icon_plane">Package</a> <span>&nbsp;</span><strong>Package Inquiry Detail</strong></h3>
</div>
...
<div class="form-box1 round-corner">
    <div class="form-box1-row">
        <div class="form-box1-row-content float-left">
         ...
         <div><label>Package Name: </label><%: Model.PackageName%></div>
        <div><label>Title: </label><%: Model.Title %></div>
         <div><label>Name: </label><%: Model.Name %></div>
        
        <div><label>Travel Date: </label><%: TimeFormat.DateFormat( Model.TravelDate.ToString()) %></div>
   ...
   <%--  <div class="buttonBar">
        <input type="button" onclick="document.location.href='/Airline/AirPackageInquiry/Index'" value="Back to List" />
    </div>--%>

<%Html.RenderPartial("VUC_Detail", Model.packageDetail); %>
<%--<div>
