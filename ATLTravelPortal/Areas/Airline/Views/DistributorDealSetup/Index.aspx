<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/DistributorMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Airline.Models.BranchDealViewModel>" %>
    ...
    <script type="text/javascript">
        ...
        $('#DeleteMasterDeal').live("click", function (event) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/Airline/MasterDistributorDealSetup/Delete/",
        ...
        function DeleteMasterDealForceFully(masterDealId, text) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/Airline/AjaxRequest/DeleteDistributorMasterDealForceFully/",
                    data: { id: masterDealId, name: text },
                    error: function () {
                        $("#loadingIndicator").html('');
                        alert('Can not delete the deal ' + text);
        ...
        function EditDeal(divId, dealId) {
            ...
            source = $("#Source").val();
            $('#' + divId).load("/Airline/AjaxRequest/AjaxDistributorDealDetail/" + dealId + "?source=" + source);
        }

        function CancelDeal(divId, dealId) {
            $("#" + divId + "_loading").html('<center><img src="<%=Url.Content("~/Content/images/indicator.gif") %>" alt="" width="16px" height="16px" /></center>');
            $("#" + divId).load("/Airline/AjaxRequest/AjaxDistributorDealCancel/" + dealId);
        }
        ...
        function DeleteDeal(divId, dealId) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/Airline/DistributorDealSetup/Delete/",
                    data: { id: dealId },
                    error: function () {
                        $("#" + divId + "_loading").html('');
        ...
        $('#saveDeal').live("click", function (event) {
            ...
            $.ajax({
                type: "POST",
                url: '/Airline/DistributorDealSetup/Create/',
        ...
        function UpdateDeal(divId, formId) {
            ...
            $.ajax({
                type: "POST",
                url: '/Airline/DistributorDealSetup/Edit/',
                data: serializeFormData,
                dataType: "html",
                success: function (serverResponse) {
        ...
        function loadCreateDialog(tag, event, target) {
            ...
            // FilterAirlineName = $("#FilterAirlineName").val();


            url = url + '/' + id + '/?FilterDealIdentifierId=' + FilterDealIdentifierId + '&FilterDealIdentifierText=' + FilterDealIdentifierText + '&FilterAirlineId=' + FilterAirlineId + '&FilterCurrencyId=' + FilterCurrencyId + '&source1=' + source;
        ...
        $(document).ready(function () {
            $("#DealMasterId").change(function () {
                ...
                if (id == "") {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '/Airline/DistributorDealSetup/Index/',
                        data: { id: id, FilterDealIdentifierId: FilterDealIdentifierId, FilterAirlineId: FilterAirlineId, FilterCurrencyId: FilterCurrencyId, Source: source },
                        dataType: "html",
                        async: true,
                        cache: false,
                        success: function (serverResponse) {
            ...
            $("#FilterAirlineName").live("change", function () {
                var text = $(this).val();
                ...
                select: function (event, ui) {
                    ...
                    if (id == "") {
                        ...
                        $.ajax({
                            type: "GET",
                            url: '/Airline/DistributorDealSetup/Index/',
                            data: { id: id, FilterDealIdentifierId: FilterDealIdentifierText, FilterAirlineId: FilterAirlineId, FilterCurrencyId: FilterCurrencyId },
                            dataType: "html",
                            async: true,
                            cache: false,
                            success: function (serverResponse) {
