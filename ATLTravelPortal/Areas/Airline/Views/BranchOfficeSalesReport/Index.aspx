<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Airline.Models.SalesReportModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Index", "BranchOfficeSalesReport", FormMethod.Post))
       {%>
    <div>
        <div class="pageTitle">
            <h3>
    ...
    <div class="contentGrid">
        ...
        <div style="width: 100%; display: inline-block; clear: both;">
            ...
            <div>
             ...
             <% using (Html.BeginForm("Index1", "BranchOfficeSalesReport", FormMethod.Post, new { @onsubmit = "return SubmitForm();", @id = "ATForm" }))
       { %>
