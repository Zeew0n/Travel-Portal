...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Index", "BranchOfficeIssuedTicket", FormMethod.Post))
       {%>
            ...
            <tr>
                ...
                <td>
                    <a href="/Airline/Invoice/Index/<%:item.PNRId %>" class="Details" target="_blank">Branch
                        Invoice</a> || <a href="/Airline/DistributorInvoice/Index/<%:item.PNRId %>" class="Details"
                            target="_blank">Distributor Invoice</a>
                </td>
            </tr>
            <% } %>
            <%}
