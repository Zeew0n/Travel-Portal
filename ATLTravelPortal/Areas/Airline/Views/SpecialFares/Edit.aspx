...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%} %>
    <% using (Html.BeginForm("Edit", "SpecialFares", FormMethod.Post, new { @class = "validate", @autocomplete = "off", enctype = "multipart/form-data" }))
       { %>
    <div class="pageTitle">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.FromCityName)%><span class="redtxt">*</span>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.ToCityName)%><span class="redtxt">*</span>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.AirlineName)%><span class="redtxt">*</span>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.RegularFare)%><span class="redtxt">*</span>
                    <%: Html.ValidationMessageFor(model=>model.RegularFare) %>
                </div>
            </div>
        </div>
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.SpecialFare)%><span class="redtxt">*</span>
                    <%: Html.ValidationMessageFor(model=>model.SpecialFare) %>
                </div>
            </div>
        </div>
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.TextBoxFor(model => model.EffectiveFrom)%><span class="redtxt">*</span>
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%: Html.TextBoxFor(model => model.ExpireOn)%><span class="redtxt">*</span>
