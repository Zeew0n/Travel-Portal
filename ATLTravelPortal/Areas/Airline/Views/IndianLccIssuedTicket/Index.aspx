    ...
    <div class="contentGrid">
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <tr>
                ...
                <td width="55">
                 <a href="<%:item.ServiceProviderETicketUrl%>/ViewETicket/<%:item.PNRId %>" class="Details" target="_blank">
            <img src="../../../../Content/Icons/view.png" style="margin-top:3px;" /></a>
            <a href="<%:item.ServiceProviderETicketUrl%>/ETicket/<%:item.PNRId %>" class="Details" target="_blank">
            <img src="../../../../Content/Icons/pdf.png" style="margin-top:3px;" /></a>
                ...
                <% else
                   { %>
                   <td>
                     <a href="/Airline/AirOfflineBook/DownloadETicket/<%:item.PNRId %>" class="Details" title="Download Eticket">
     <br />
