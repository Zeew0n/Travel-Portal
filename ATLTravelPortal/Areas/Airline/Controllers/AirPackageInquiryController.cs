...
namespace ATLTravelPortal.Areas.Airline.Controllers
{
    ...
    [ValidateInput(false)]
    public class AirPackageInquiryController : Controller
    {
        AirPackageInquiryModel _modObj = new AirPackageInquiryModel();
        AirPackageInquiryProvider _provider = new AirPackageInquiryProvider();
        ...
        private AirPackageInquiryModel GetViewModelList(int? page, string sqlString = "1=1")
        {
            int currentPageIndex = page.HasValue ? page.Value : 1;
            int defaultPageSize = 50;
           
            _modObj.PackagesList = _provider.GetList().ToPagedList(currentPageIndex, defaultPageSize); 
