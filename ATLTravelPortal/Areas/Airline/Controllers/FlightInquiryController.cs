...
namespace ATLTravelPortal.Areas.Airline.Controllers
{
    ...
    [ValidateInput(false)]
    public class FlightInquiryController : Controller
    {
        FlightInquiryModel _modObj = new FlightInquiryModel();
        FlightInquiryProvider _provider = new FlightInquiryProvider();
        ...
        [NonAction]
        private FlightInquiryModel GetViewModelList(int? page, string sqlString = "1=1")
        {
