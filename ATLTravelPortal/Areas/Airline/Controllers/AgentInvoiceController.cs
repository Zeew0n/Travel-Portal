...
{
    public class AgentInvoiceController : ATLTravelPortal.Areas.Airline.Controllers.PartialViewRendererController
    {
        AgentInvoiceDetailProvider provider = new AgentInvoiceDetailProvider();
