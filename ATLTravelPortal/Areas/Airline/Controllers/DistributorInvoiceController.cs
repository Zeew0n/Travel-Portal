...
{
    public class DistributorInvoiceController : ATLTravelPortal.Areas.Airline.Controllers.PartialViewRendererController
    {
        DistributorInvoiceDetailProvider provider = new DistributorInvoiceDetailProvider();
