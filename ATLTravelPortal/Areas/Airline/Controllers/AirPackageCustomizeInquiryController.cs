...
namespace ATLTravelPortal.Areas.Airline.Controllers
{
    ...
    [ValidateInput(false)]
    public class AirPackageCustomizeInquiryController : Controller
    {
        AirPackageCustomizeInquiryModel _modObj = new AirPackageCustomizeInquiryModel();
        AirPackageCustomizeInquiryProvider _provider = new AirPackageCustomizeInquiryProvider();
        ...
        private AirPackageCustomizeInquiryModel GetViewModelList(int? page, string sqlString = "1=1")
        {
