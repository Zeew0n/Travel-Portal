...
{
    public class InvoiceDetailProvider
    {
        private int createdBy { get; set; }
        private DateTime createdDate { get; set; }

        TravelPortalEntity.EntityModel _ent = new EntityModel();
        public InvoiceDetailProvider()
        { }
        ...
        private InvoiceAgencyDetailModel GetAgentDetail(int agentid)
        {
            ...
            //                       GetZonesById(agentDetail.ZoneId).ZoneName + " " +
            //                       GetZonesById(agentDetail.ZoneId).ZoneName;
            agencyDetail.Address = GetCountryById(agentDetail.NativeCountry).CountryName + " " +
                                zonename;
        ...
        {
            var pnrTickets = _ent.TBO_PNRTickets.ToList().Find(id => id.PassengerId == paxId);
            return pnrTickets;
        }
