...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box3">
        <div class="userinfo">
            <div class="row-1">
                <div class="pageTitle">
                    <h3>
                        <a class="icon_plane" href="#">Booking Request</a> <span>&nbsp;</span><strong>In Process
                            List</strong>
                    </h3>
                </div>
            </div>
    ...
    <%Html.RenderPartial("~/Areas/Train/Views/BranchBookingRequest/VUC_SearchOption.ascx", Model);%>
