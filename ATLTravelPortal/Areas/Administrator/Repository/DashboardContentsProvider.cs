...
{
    public class DashboardContentsProvider
    {
        EntityModel ent = new EntityModel();

        public List<DashboardContentsModel> GetDashBoardContentsList()
        {
            var result = ent.Core_DashboardContents;
        ...
        {
            Core_DashboardContents obj = new Core_DashboardContents();
            ...
            ent.AddToCore_DashboardContents(obj);
            ent.SaveChanges();
        ...
        {
            Core_DashboardContents result = ent.Core_DashboardContents.Where(u => u.DashboardContentId == model.DasbBoardContentId).FirstOrDefault();
        ...
        {
            List<Core_DashboardContents> result = ent.Core_DashboardContents.Where(u => u.DashboardContentId != Id).ToList();
        ...
        {
            Core_DashboardContents result = ent.Core_DashboardContents.Where(x => x.DashboardContentId == id).FirstOrDefault();
            if (result != null)
            {
        ...
        {
            Core_DashboardContents result = ent.Core_DashboardContents.Where(x => x.CreatedBy == Userid).FirstOrDefault();
            if (result != null)
            {
                DashboardContentsModel model = new DashboardContentsModel();
