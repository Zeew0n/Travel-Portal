...
{
    public class DistributorAgentLedgerController : Controller
    {
        //
        ...
        public ActionResult Index(AgentLedgerTransactionsModel model)
        {
            ...
            model.LedgerList = pro.GetTransactionList(model.AgentId, 1, (DateTime)model.FromDate, (DateTime)model.ToDate, model.CurrencyId, 1);
            model.AgentList = ser.GetAllAgentListByDistributorId();
            if (model.AgentId > 0)
            {
