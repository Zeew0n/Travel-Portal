...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Details", "CreditLimit", new { id = Model.AgentCreditLimitId }, FormMethod.Post, new { @autocomplete = "off" }))
       {%>
    <%: Html.ValidationSummary(true) %>
    <div class="pageTitle">
        <div class="float-right">
            <%:Html.ActionLink("Cancel", "Index", new { controller = "DistributorCreditLimit" }, new { @class = "linkButton" })%>
        </div>
        <h3>
    ...
    <div class="form-box1-row">
        <div class="form-box1-row-content float-left">
           ...
           <a href="/Administrator/CreditLimit/Reject/<%:Model.AgentCreditLimitId %>"  class="linkButton">Reject</a>
        </div>
    </div>
    <div class="clearboth">
    </div>
