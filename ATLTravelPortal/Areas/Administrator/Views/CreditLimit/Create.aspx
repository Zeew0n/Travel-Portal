...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%using (Ajax.BeginForm("Create", "CreditLimit", new AjaxOptions()
                      {
    ...
    <div class="pageTitle">
        <div class="pageTitle">
        <h3>
            <a href="#">Account Management</a> <span>&nbsp;</span><strong>Credit Limit Management(Branch Office)</strong><span>&nbsp;</span><strong>Create</strong>
        </h3>
    </div>
    </div>
    <div class="row-1">
    ...
    <script type="text/javascript">
        $(function () {
            $("#ddlTypeId").change(function () {
                ...
                $.ajax({
                    url: "/Administrator/CreditLimit/Create",
                    type: "POST",
                    dataType: "html",
