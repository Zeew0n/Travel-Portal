...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "AgentCreditLimit", FormMethod.Post))
       {%>
    <%: Html.ValidationSummary(true)%>
    <div class="pageTitle">
        <div class="float-right">
            <input type="submit" value="Update" class="btn3" />
            <%:Html.ActionLink("Cancel", "Index", new { controller = "AgentCreditLimit" }, new { @class = "linkButton float-right" })%>
        </div>
        <h3>
            <a href="#">Account Management</a> <span>&nbsp;</span><strong>Credit Limit Management</strong><span>&nbsp;</span><strong>Edit</strong>
        </h3>
    </div>
    <div class="row-1">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%: Html.TextAreaFor(model => model.Comments, new {@cols="20", @rows="5",@style="width: 180px; height: 102px;" })%>
