...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%using (Ajax.BeginForm("Create", "AgentCreditLimit", new AjaxOptions()
                      {
    ...
    <div class="pageTitle">
        <h3>
            <a href="#">Account Management</a> <span>&nbsp;</span><strong>Credit Limit Management</strong><span>&nbsp;</span><strong>Create</strong>
        </h3>
    </div>
    <div class="row-1">
    ...
    <script type="text/javascript">
        $(function () {
            $("#ddlTypeId").change(function () {
                ...
                $.ajax({
                    url: "/Administrator/AgentCreditLimit/Create",
                    type: "POST",
                    dataType: "html",
