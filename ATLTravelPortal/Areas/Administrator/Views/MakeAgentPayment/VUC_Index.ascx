                                                ...
                                                <td><%:ATLTravelPortal.Helpers.TimeFormat.DateFormat(eachitem.ChequeIssueDate.ToString()) %></td>
                                                 ...
                                                 <td><%:(eachitem.status ==1 ? "Approved" :( (eachitem.status ==2 ? "Processing" : "Rejected"))) %><span class="<%:cssActiveInacticehighlight %>"></span></td>
                                                  ...
                                                  <td> 
                                                   ...
                                                   <a href="/Administrator/MakeAgentPayment/Details/<%:eachitem.DepositId %>" class="details"></a> 
                                                  |  <% if (eachitem.status != 1)
                                                      { %>
                                                   <a href="/Administrator/MakeAgentPayment/Edit/<%:eachitem.DepositId %>" class="edit"></a> |
                                                    <%} %>
                                                 
                                                   <a href="/Administrator/MakeAgentPayment/Delete/<%:eachitem.DepositId %>" class="delete" title="Reject" onclick="return confirm('Are you sure you want to reject this payment?')"></a>
