<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdministratorMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.MakePaymentModel>" %>
...
<%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
    ...
    <% using (Html.BeginForm("Edit", "MakeAgentPayment", FormMethod.Post, new { @id = "ATForm", enctype = "multipart/form-data" }))
       {%>
   ...
   <div class="tbl_Data">
        <ul class="buttons-panel float-right">
            <li>
                <input type="submit" value="Approve" class="btn1" /></li>
            <li>
                <input type="button" onclick="document.location.href='/Administrator/MakeAgentPayment/Index'"
                    value="Cancel" /></li>
        </ul>
        ...
        <%:Html.DropDownListFor(model => model.AgentId, Model.AgentList, "-----Select Agent-----")%>
        ...
        $(document).ready(function () {
            ...
            $("#RTGSBankId").change(function () {
                ...
                if (id == "") {
                    ...
                    var url = "/Airline/AjaxRequest/GetBankBranchBasedonBankId";
