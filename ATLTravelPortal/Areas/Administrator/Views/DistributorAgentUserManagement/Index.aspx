<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdministratorMain.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<TravelPortalEntity.View_DistributorDetails>>" %>
    ...
    <div class="pageTitle">
        <div class="float-right">
            <ul>
                ...
                <li>
                    <input type="button" value="Back To Distributor List" class="cancel" onclick="document.location.href='/Administrator/DistributorManagement/'" /></li>
            </ul>
        </div>
        <h3>
            <a href="#">Distributor User Management</a> <span>&nbsp;</span><strong>Distributor User's:
                <%:ViewData["DistributorOfficeName"]%></strong>
        </h3>
    </div>
    <div class="contentGrid">
        <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;"
            ...
            <% var sno = 0;
               ...
               foreach (View_DistributorDetails item in Model)
               {
                   sno++;
                ...
                <tr>
                    <td colspan="8" style="text-align: right; padding: 0px;">
                        <p style="background: #ebebeb; width: 240px; float: right; -moz-border-radius-topleft: 0px;
                            ...
                            <%:Html.ActionLink(LockUnlock, "LockUnlockDistributorUser", new { controller = "DistributorAgentUserManagement", @id = item.UserName }, new { @onclick = "return confirm('Do you really want to " + LockUnlock + " ?')" })%>
                            <a href="/Administrator/DistributorAgentUserManagement/ResetPassword/<%:item.UserName%>"
                                title="Reset Password" onclick="return confirm('Are you sure you want to reset password for <%: item.UserName%>?')">
                                Reset Password</a>
                        </p>
                    </td>
                </tr>
