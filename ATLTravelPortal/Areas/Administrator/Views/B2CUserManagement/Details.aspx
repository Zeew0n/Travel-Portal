   ...
   <div class="row-1">
    ...
    <div class="pageTitle">
           <div class="float-right">
            <ul>
                <li>
                    <%:Html.ActionLink("Cancel", "Index", new { controller = "B2CUserManagement" }, new { @class = "linkButton" })%></li>
            </ul>
        </div>
        <h3>
            <a class="icon_plane" href="#">B2C</a> <span>&nbsp;</span><strong>User Management</strong>
        </h3>
    </div>
    <br />
