...
<%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
    ...
    <div class="tbl_Data">
        <ul class="buttons-panel float-right">
            ...
            <li>
                <input type="button" onclick="document.location.href='/Airline/DistributorMakePayment/Index'"
                    value="Cancel" /></li>
        </ul>
        ...
        <div class="radioWithoutWidth">
            ...
            Cash Given To&nbsp&nbsp;
            <%:Html.RadioButton("rdbPaymentMode", "CreditRequest", false, new { id = "CreditRequest", name = "CreditRequest", title = "Credit Request" })%>
            Credit Request
        </div>
        <br />
        <br />
        ...
        <div id="trCreditRequest">
        <div class="divLeft">
                <%: Html.LabelFor(model => model.CreditRequestCurrencyId)%>
               <%: Html.DropDownListFor(model=>model.CreditRequestCurrencyId, Model.CreditRequestCurrencyList) %>
                <%: Html.ValidationMessageFor(model => model.CreditRequestCurrencyId, "*")%>
            </div>
            <div class="divLeft">
                <%: Html.LabelFor(model => model.CreditAmount)%>
                <%: Html.TextBoxFor(model => model.CreditAmount, new { @Value = "" })%>
                <%: Html.ValidationMessageFor(model => model.CreditAmount, "*")%>
            </div>
             <div class="divLeft">
                <%: Html.LabelFor(model => model.CreditRequestRemakrs)%>
                <%: Html.TextAreaFor(model => model.CreditRequestRemakrs, new { @Value = "",@Style = " width:190px; margin-left:1px; padding:5px;" })%>
                <%: Html.ValidationMessageFor(model => model.CreditRequestRemakrs, "*")%>
            </div>
        </div>
    </div>
    <%} %>
