...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    ...
                    <%:Html.DropDownListFor(model => model.DistributorId, Model.DistributorList)%>
    ...
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        ...
        <tr>
        <td colspan="8"><br /><br />
        <%if (Model.DistributorId != null && Model.AvailableBalance != null)
      { %>
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        class="GridView" width="100%">
        <tr>
    ...
    <%} %>
        ...
        <tr>
            <td colspan="8">
            <br /><br />
    <%if (Model.DistributorId != null && Model.CreditLimitList.Count() > 0)
      { %>
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        class="GridView" width="100%">
        <thead>
