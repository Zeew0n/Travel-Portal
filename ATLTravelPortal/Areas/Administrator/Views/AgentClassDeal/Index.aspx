...
<div>
    ...
    <%using (Html.BeginForm("Index", "AgentClassDeal", FormMethod.Post, new { @class = "validate" }))
      { %>
    <div id="ListTable">
...
<asp:Content ID="Content4" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript" language="javascript">
        function SaveAgentClassDeal(id) {
            ...
            $.ajax({
                type: "POST",
                url: '/Administrator/AgentClassDeal/Index',
                data: { agentClassId: agentClassId, masterDealId: masterDealId, hotelMasterDealId: hotelMasterDealId },
                dataType: "html",
                async: true,
                cache: false,
