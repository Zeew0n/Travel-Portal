...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "Contents", FormMethod.Post, new { @class = "validate", @autocomplete = "off", enctype = "multipart/form-data" }))
       { %>
    <div class="pageTitle">
        ...
        <h3>
            <a href="#">CMS</a> <span>&nbsp;</span><strong>Page</strong><span>&nbsp;</span><strong>Edit</strong>
        </h3>
    </div>
