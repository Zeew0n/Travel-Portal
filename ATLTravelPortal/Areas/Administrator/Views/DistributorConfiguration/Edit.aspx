...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "DistributorConfiguration", FormMethod.Post, new { @class = "validate", @autocomplete = "off", enctype = "multipart/form-data" }))
       { %>
    <div class="pageTitle">
    ...
    <div>
      <%:Html.HiddenFor(model=>model.LayoutSettingId) %>
    </div>
    <div class="form-box1 round-corner">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left" style="width: 450px;">
                ...
                <div style="width: 166px; height: 63px">
                    <img src='<%= Url.Action("GetImage","DistributorConfiguration", new {id=Model.LayoutSettingId })%>'
                        alt="" />
                </div>
                <div>
