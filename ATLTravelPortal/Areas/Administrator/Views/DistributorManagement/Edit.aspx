...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "DistributorManagement", FormMethod.Post))
       {%>
     ...
     <div class="pageTitle">
        <div class="float-right">
            <ul>
                ...
                <div class="float-right">
                    <input type="submit" value="Update" id="CreateNew" />
                      <input type="button" value="Cancel" onclick="document.location.href='/Administrator/DistributorManagement/'" /> </div>
            </ul>
        </div>
        <h3>
