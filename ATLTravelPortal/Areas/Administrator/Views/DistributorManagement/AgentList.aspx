...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div class="pageTitle">
        <div class="float-right">
            <ul>
             <li>
                ...
                <li>
                          ...
                          <input type="button" value="Back to List" class="cancel" onclick="document.location.href='/Administrator/DistributorManagement'" />
         ...
         <h3>
            <a href="#">Distributor Management</a> <span>&nbsp;</span><strong>Agent</strong>
        </h3>
...
var mobilenumber = ser.AgentMobileNumber(item.AgentId);
                    ...
                    <td>
                        ...
                        <p>
                         <a href="/Administrator/DistributorManagement/DistributorAgentEdit/<%:item.AgentId %>" title="Edit">Edit</a>&nbsp;|&nbsp;
                            <a href="/Administrator/DistributorManagement/DistributorAgentSetting/<%:item.AgentId %>?DISId=<%:Model.DistributorId %>" title="Agent User">(Settings)</a>
