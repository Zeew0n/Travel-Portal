<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdministratorMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.AgentLedgerTransactionsModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-1">
        ...
        <div class="form-box1-row">
            <div class="form-box1-row-content float-left">
                <div>
                    <%: Html.LabelFor(model => model.BranchOfficeId)%>
                    <%:Html.DropDownListFor(model => model.BranchOfficeId, Model.BranchOfficeList)%>
    ...
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        ...
        <tr>
        <td colspan="8"><br /><br />
        <%if (Model.BranchOfficeId != null && Model.AvailableBalance != null)
      { %>
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        class="GridView" width="100%">
        <tr>
    ...
    <%} %>
        ...
        <tr>
            <td colspan="8">
            <br /><br />
    <%if (Model.BranchOfficeId != null && Model.CreditLimitList.Count() > 0)
      { %>
    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; border:1px solid #ccc;"
        class="GridView" width="100%">
        <thead>
