<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.DistributorAgentManagementModel>" %>
            ...
            <ul>
             <li>
                ...
                <li>
                          ...
                          <input type="button" value="Back to List" class="cancel" onclick="document.location.href='/Administrator/BranchDistributorManagement'" />
...
var mobilenumber = ser.AgentMobileNumber(item.AgentId);
                    ...
                    <td>
                        ...
                        <p>
                         <a href="/Administrator/BranchDistributorManagement/BranchDistributorAgentEdit/<%:item.AgentId %>" title="Edit">Edit</a>&nbsp;|&nbsp;
                            <a href="/Administrator/BranchDistributorManagement/BranchDistributorAgentSetting/<%:item.AgentId %>?DisId=<%:Model.DistributorId%>" title="Agent User">(Settings)</a>
