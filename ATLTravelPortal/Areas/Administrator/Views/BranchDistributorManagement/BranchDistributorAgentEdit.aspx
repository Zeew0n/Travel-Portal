<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.AgentModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("BranchDistributorAgentEdit", "BranchDistributorManagement", FormMethod.Post, new { @autocomplete = "off", enctype = "multipart/form-data" }))
       {%>
