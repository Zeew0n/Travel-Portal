<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.DistributorManagementModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="pageTitle">
        <div class="float-right">
            <ul>
                ...
                <li>
                    <input type="button" onclick="document.location.href='/Administrator/BranchDistributorManagement/Create/'"
                        value="New" class="new" />
                </li>
            </ul>
        </div>
    ...
    <% using (Html.BeginForm("DistributorSearch", "BranchDistributorManagement", FormMethod.Post))
       {%>
    <div>
        <label>
    ...
    <script type="text/javascript">
        ...
        $("#Status").live("change", function () {
            ...
            if (IsActive == "") {
                ...
                $.ajax({
                    type: "GET",
                    url: "/Administrator/BranchDistributorManagement/Index",
