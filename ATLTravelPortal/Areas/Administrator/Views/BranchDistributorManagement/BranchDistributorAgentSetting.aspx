<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.AgentSettingModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
        ...
        <%using (Html.BeginForm("BranchDistributorAgentSetting", "BranchDistributorManagement", FormMethod.Post, new { @class = "validate" }))
                 { %>
