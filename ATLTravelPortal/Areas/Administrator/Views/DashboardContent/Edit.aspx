...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "DashboardContent", FormMethod.Post, new { @class = "validate", @autocomplete = "off", enctype = "multipart/form-data" }))
       { %>
    <div class="pageTitle">
      <div class="float-right">
        <input type="submit" value="Save" />
        <input type="button" onclick="document.location.href='/Administrator/DashboardContent/Index'"
            value="Cancel" />
    </div>
        <h3>
            <a href="#" class="icon_plane">CMS</a> <span>&nbsp;</span><strong>Dashboard Content
                (B2C)</strong><span>&nbsp;</span><strong>Edit</strong>
        </h3>
    </div>
