<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdministratorMain.Master"
    Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.VoidCancellationRequestRuleModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="pageTitle">
            <h3>
                <a href="#" class="icon_plane">System Setup</a> <span>&nbsp;</span><strong>Void Cancellation
                    Request Rule</strong>
            </h3>
        </div>
    </div>
    ...
    <div>
        <label>
            Within Hour</label>
        <%: Html.TextBoxFor(model=>model.WithinHour) %>
        hr
        <%: Html.ValidationMessageFor(model=>model.WithinHour) %>
    </div>
    <br />
    <div>
        <label>
        ...
        <%: Html.ValidationMessageFor(model=>model.RuleOn) %>
    </div>
    <br />
