<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdministratorMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.AgentSettingModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Distributor's Agents Setting
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
           ...
           <div class="float-right">
            <ul>
                ...
                <li>
                    ...
                    <input type="button" value="Cancel" class="cancel" onclick="document.location.href='/Administrator/BranchOfficeManagement/DistributorAgentList/<%:Model.DistributorId %>?name=Distributor&&BOId=<%:Model.branchofficeid %>'" />
        ...
        <h3>
            <a href="#">Agent Management</a> <span>&nbsp;</span><strong>Agents</strong><span>&nbsp;</span><strong>Agents Setting</strong>
        </h3>
    </div>
        <%using (Html.BeginForm("DistributorAgentSetting", "BranchOfficeManagement", FormMethod.Post, new { @class = "validate" }))
                 { %>
                 <%: Html.HiddenFor(model=>model.branchofficeid) %>
                 <%: Html.HiddenFor(model=>model.DistributorId) %>
     <div class="row-1">
   
   <h3 class="pageTitle" style="color:Green;"> <b><%: Model.AgentName %></b> </h3>
      ...
      <div class="form-box1-row" style="border:1px solid #ccc; padding:5px; width:45%;"> 
                     ...
                     <div> <h5  class="border-btm">Add Setting</h5> 
                      <p> 
                    <label style="width:125px;"><strong>Select All</strong> </label> <input type="checkbox" name="ChkIdAll" class="ChkBoxParent"/> <br />
                    </p>
                         <% foreach (var agentsetting in Model.agentsettinglist)
                            ...
                            <p>
                              ...
                              <input type="checkbox" name="ChkSettingId" value="<%=agentsetting.SettingId%>" checked="checked" class="ChkBoxChild"/>
                              <%} else{ %>
                              <input type="checkbox" name="ChkSettingId" value="<%=agentsetting.SettingId%>" class="ChkBoxChild"/>
                              <%} %>
                               <label>  <% =agentsetting.SettingName%></label>    
                               </p> 
                                <%}%>
