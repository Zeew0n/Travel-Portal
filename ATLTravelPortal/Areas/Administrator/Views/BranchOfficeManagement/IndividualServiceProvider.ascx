...
<fieldset class="style1" style="width: 200px; float: left; padding: 0 10px 0;">
    <legend>
        <input type="checkbox" name="ServiceProviders[<%:count %>].ServiceProviderId" value="<%=Model.ServiceProviderId%>"
            <%:checkvalue %> id="checked<%:Model.ServiceProviderId%>" class="ServiceProvidercheckbox" />&nbsp;&nbsp;&nbsp;
