...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   Distributor's Agent Edit
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
    <% Html.EnableClientValidation(); %>
    <% using (Html.BeginForm("DistributorAgentEdit", "BranchOfficeManagement", FormMethod.Post, new { @autocomplete = "off", enctype = "multipart/form-data" }))
       {%>
                            ...
                            <table id="AgentBank-table" class="jqueryaddmore ">
                                ...
                                <tbody>
                                    ...
                                    <tr id="AgentBank-method-<%= Bankmodel.AgentBankId %>">
                                        ...
                                        <td>
                                            <a href="#" class="edit-AgentBank-method-button" meta:id="<%= Bankmodel.AgentBankId %>">
                                                <img border="0" class="edit" src="" title="Edit" /></a> <a href="#" class="delete-AgentBank-method-button"
                                                    meta:id="<%= Bankmodel.AgentBankId %>">
