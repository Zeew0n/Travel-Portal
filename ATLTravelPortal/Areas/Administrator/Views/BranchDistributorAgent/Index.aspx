...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="pageTitle">
        <div class="float-right">
            <ul>
                ...
                <li>
                    <input type="button" onclick="document.location.href='DistributorAgentManagement/Create'" value="New"
                        class="new" />
                </li>
            </ul>
        </div>
    ...
    <%} %>
    <% using (Html.BeginForm("Index", "DistributorAgentManagement", FormMethod.Post, new { @id = "ATForm", enctype = "multipart/form-data" }))
       {%>
    <div>
    ...
    <script type="text/javascript">
        ...
        $("#model1_ddlStatus").live("change", function () {
            ...
            if (IsActive == "") {
                ...
                $.ajax({
                    type: "GET",
                    url: "/Administrator/DistributorAgentManagement/Index",
