                        ...
                        <p>
                            <a href="/Administrator/DistributorAgentManagement/Details/<%: item.AgentId %>" class="details"
                                title="Details"></a><a href="/Administrator/DistributorAgentManagement/Edit/<%: item.AgentId %>"
                                    ...
                                    </a><a href="/Administrator/DistributorAgentUserManagement/Index/<%:item.AgentId %>" title="Agent User">
                                        Agent's User</a> <a href="/Administrator/DistributorAgentSetting/Index/<%:item.AgentId %>" title="Agent User">
                                            Setting</a>
                        </p>
                    </td>
                </tr>
