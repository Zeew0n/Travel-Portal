...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="pageTitle">
        <div class="float-right">
            <ul>
                ...
                <li>
                    <input type="button" value="Cancel" class="cancel" onclick="document.location.href='/Administrator/DistributorAgentManagement/'" /></li>
            </ul>
        </div>
        <h3>
    ...
    <% using (Html.BeginForm("Create", "DistributorAgentManagement", FormMethod.Post, new { @class = "validate", @autocomplete = "off", enctype = "multipart/form-data" }))
       {%>
