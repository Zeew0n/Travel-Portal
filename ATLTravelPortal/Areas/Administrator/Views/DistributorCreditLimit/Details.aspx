...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <% Html.EnableClientValidation(); %>
    <% using (Html.BeginForm("Details", "DistributorCreditLimit", new { id = Model.AgentCreditLimitId }, FormMethod.Post, new { @autocomplete = "off" }))
      {%>
    ...
    <input type="submit" value="Approve" />
            <a href="/Administrator/DistributorCreditLimit/Index"  class="linkButton">Reject</a>
