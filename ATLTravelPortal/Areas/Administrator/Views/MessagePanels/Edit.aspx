...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    %>
    <% using (Html.BeginForm("Edit", "MessagePanels", FormMethod.Post, new { @id = "ATForm", enctype = "multipart/form-data" }))
       {%>
    ...
    <div class="tbl_Data">
        ...
        <div class="tbl_Data_Tlt">
            <h3>
                <a href="#" class="icon_plane">Edit</a> <span>&nbsp;</span><strong> Edit</strong>
            </h3>
        </div>
    </div>
    <div class="row-1">
                ...
                <div class="form-box1-row-content float-left">
                    <div>
                        <% List<SelectListItem> Panellist = new List<SelectListItem>{
                                        ...
                                        new SelectListItem { Selected = false, Text = "Indian LCC Search", Value = "3"},
