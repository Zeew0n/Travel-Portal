...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Details", "BranchOfficeCreditLimit", new { id = Model.AgentCreditLimitId }, FormMethod.Post, new { @autocomplete = "off" }))
       {%>
    <%: Html.ValidationSummary(true) %>
    <div class="pageTitle">
        <div class="float-right">
            <%:Html.ActionLink("Cancel", "Index", new { controller = "BranchOfficeCreditLimit" }, new { @class = "linkButton" })%>
        </div>
        <h3>
    ...
    <div class="form-box1-row">
        <div class="form-box1-row-content float-left">
            ...
            <a href="/Administrator/BranchOfficeCreditLimit/Index" class="linkButton">Reject</a>
        </div>
    </div>
    <div class="clearboth">
    </div>
