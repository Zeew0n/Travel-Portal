<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/BranchOfficeMain.Master" Inherits="System.Web.Mvc.ViewPage<ATLTravelPortal.Areas.Administrator.Models.CreditLimitModel>" %>
        ...
        <div class="float-right">
            <ul>
             ...
             <%Html.RenderPartial("Utility/VUC_MessagePanel"); %>
                ...
                <li>
                    <%:Html.ActionLink("Create New", "Create", new { controller = "BranchOfficeCreditLimit" }, new { @class = "linkButton" })%></li>
            </ul>
        </div>
        <h3>
            ...
            <div class="form-box1-row">
                <div class="form-box1-row-content float-left">
                    <div>
                        <label>
                           Distributor</label>
                        <%:Html.AutoCompleteFor(model => Model.AgencyName, x => x.AgencyName, "ListAllDistributors", "Administrator/AjaxRequest", 2)%>
            ...
            $(function () {
                $("#AgencyName").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "/Administrator/AjaxRequest/FindDistributorName", type: "POST", dataType: "json",
     ...
     <script language="javascript" type="text/javascript">
         $("#AmountType").live("change", function () {
             ...
             if (AmountType == "") {
                 ...
                 $.ajax({
                     type: "GET",
                     url: "/Administrator/BranchOfficeCreditLimit/Index",
