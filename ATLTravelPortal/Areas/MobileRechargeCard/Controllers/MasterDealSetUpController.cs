    ...
    public class MasterDealSetUpController : Controller
    {
        ...
        public ActionResult Create()
        {
            MasterDealviewModel viewmodel = new MasterDealviewModel()
            {
                ...
                DealTypeList = mDealProvider.GetAllDealTypeList(3),
            };
        ...
        public ActionResult Create(MasterDealviewModel model)
        {
            ...
            try
            {
                if (!ModelState.IsValid)
                {
                    ...
                    {
                        mDealProvider.CopyMobileDealfromOneToAnother(model.DealName, model.DealMasterId, model.DealTypeId, model.EffectiveFrom, model.ExpireOn);
                    }
                    else
                    {
        ...
        public ActionResult Delete(int id, string name)
        {
            ...
            try
            {
                ...
                result = mDealProvider.Delete_Tkt_MobileDealMasters(id, obj.AppUserId);
