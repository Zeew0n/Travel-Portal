    ...
    <script type="text/javascript">
        ...
        $('#DeleteMasterDeal').live("click", function (event) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/MobileRechargeCard/MasterDealSetup/Delete/",
        ...
        function DeleteMasterDealForceFully(masterDealId, text) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/MobileRechargeCard/AjaxRequest/DeleteMobileMasterDealForceFully/",
                    data: { id: masterDealId, name: text },
                    error: function () {
                        $("#loadingIndicator").html('');
                        alert('Can not delete the deal ' + text);
        ...
        function EditDeal(divId, dealId) {
            ...
            $('#' + divId).load("/MobileRechargeCard/AjaxRequest/AjaxDealDetail/" + dealId + "?source=" + source);
        }

        function CancelDeal(divId, dealId) {
            $("#" + divId + "_loading").html('<center><img src="<%=Url.Content("~/Content/images/indicator.gif") %>" alt="" width="16px" height="16px" /></center>');
            $("#" + divId).load("/MobileRechargeCard/AjaxRequest/AjaxDealCancel/" + dealId);
        }
        function DeleteDeal(divId, dealId) {
            ...
            if (confirm(alertMsg)) {
                $.ajax({
                    type: "POST",
                    url: "/MobileRechargeCard/DealSetup/Delete/",
                    data: { id: dealId },
                    error: function () {
                        $("#" + divId + "_loading").html('');
        ...
        $('#saveDeal').live("click", function (event) {
            ...
            $.ajax({
                type: "POST",
                url: '/MobileRechargeCard/DealSetup/Create/',
        ...
        function UpdateDeal(divId, formId) {
            ...
            $.ajax({
                type: "POST",
                url: '/MobileRechargeCard/DealSetup/Edit/',
                data: serializeFormData,
                dataType: "html",
                success: function (serverResponse) {
        ...
        $(document).ready(function () {
            $("#DealMasterId").change(function () {
                ...
                if (id == "") {
                    ...
                    var url = "/MobileRechargeCard/AjaxRequest/GetMobileDealIdentifiers";
                    ...
                    $.ajax({
                        type: "GET",
                        url: '/MobileRechargeCard/DealSetup/Index/',
            ...
            $("#FilterDealIdentifierId").change(function () {
                ...
                if (id == "") {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '/MobileRechargeCard/DealSetup/Index/',
                        data: { id: id, FilterDealIdentifierId: FilterDealIdentifierText },
                        dataType: "html",
                        async: true,
                        cache: false,
                        success: function (serverResponse) {
