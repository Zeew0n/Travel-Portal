...
<% using (Html.BeginForm("Create", "MasterDealSetUp", FormMethod.Post, new { @class = "validate", @onsubmit = "return validateForm();" }))
   {%>
...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        var expireOn = $("#ExpireOn").val();
        if (dealName.length != 0 && dealTypeId > 0 && effectiveFrom.length != 0 && expireOn.length != 0) {
            return true;
        }
