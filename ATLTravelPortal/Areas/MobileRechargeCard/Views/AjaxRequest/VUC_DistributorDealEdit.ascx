...
<% using (Html.BeginForm("Index", "DistributorsDealSetup", FormMethod.Post, new { @id = "myUpdateForm" + counterIndex, @name = "myUpdateForm" + counterIndex }))
   { %>
<table width="100%" cellpadding="0" cellspacing="0" class="GridView">
    ...
    <tbody>
        ...
        Html.HiddenFor(model => model.DealId, new { @id ="editDealId" })               
                ...
                <%: Html.DropDownListFor(model => model.DealIdentifierId, Model.DealIdentifierList,"--Select--", new { @style="width:200px;"})%>
